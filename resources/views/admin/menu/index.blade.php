...
<main class="app-content">
    <div class="app-title">
        <div>
            <h1><i class="bi bi-table"></i> Data Menu</h1>
            <p>Data menu Kopi Zero</p>
        </div>
                            ...
                            <tbody>
                                ...
                                @foreach ($menus as $menu)
                                    <tr>
                                        ...
                                        <td>
                                            {{ $menu->H_Hot === '0.00' ? '-' : str_replace('000', '', number_format($menu->H_Hot, 0, ',', 'k')) }}
                                        </td>
                                        <td>
                                            {{ $menu->H_Ice === '0.00' ? '-' : str_replace('000', '', number_format($menu->H_Ice, 0, ',', 'k')) }}
                                        </td>
                                        <td>
                                            {{ $menu->deskripsi }}
                                        </td>
                                        <td>
                                            <img src="/image/menu-img.png" width="100px" height="100px">
                                        </td>
                                        <td>
